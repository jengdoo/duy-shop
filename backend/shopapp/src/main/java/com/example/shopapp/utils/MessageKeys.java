...
public class MessageKeys {
    ...
    public static final String REGISTER_FAILED = "user.register.password_not_match";
    ...
    public static final String INSERT_PRODUCT_SUCCESSFULLY ="product.insert.product_successfully";
